...
\begin{itemize}
	...
	\begin{itemize*}
                \item Part of a team responsible for
                        ...
                        Personally accountable for depot activation of F-22 SMS (stores management system),
                        radar, and power supply's.
                        Responsible to coordinate and 
                        provide engineering support for these systems.
                \item provided SPO (systems program office) systems engineering support of aircraft simulators.
                        ...
                        training requirement and/or obsolescence. Oversee the testing of new systems to ensure
...
\begin{itemize}
	...
	\headerrow
        ...
        \begin{itemize*}
                \item Amateur radio operator (KE7OHB), have communicated with others all other the US.
